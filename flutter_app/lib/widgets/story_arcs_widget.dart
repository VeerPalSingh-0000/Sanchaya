                                ...
                                child: GestureDetector(
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      boxShadow: isOpen
                                          ? [BoxShadow(color: AppTheme.primary.withOpacity(0.6), blurRadius: 10)]
                                          : null,
                                    ),
                                  ),
                                ),
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: isOpen ? AppTheme.surfaceLight.withOpacity(0.5) : Colors.transparent,
                                      borderRadius: BorderRadius.circular(16),
                                      border: isOpen ? Border.all(color: AppTheme.primary.withOpacity(0.3)) : Border.all(color: Colors.transparent),
                                    ),
                                    child: Row(
